...
COPY public.songs (id, name, "youtubeLink", score) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.songs_id_seq', 22, true);
...
--
-- Name: songs songs_youtubeLink_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
